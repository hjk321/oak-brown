...
const u8 gText_Search[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}Sort");
...
const u8 gText_LightestMode[] = _("Weight Mode");
const u8 gText_SmallestMode[] = _("Height Mode");
...
const u8 gText_SearchNoColor[] = _("Sort");
...
const u8 gText_OakForbidsUseOfItemHere[] = _("Tim's words echo … … …\p{PLAYER}! There's a time and place\nfor everything! But not now!{PAUSE_UNTIL_PRESS}");
const u8 gText_TimPizzaUse[] = _("Tim's words echo … … …\p{PLAYER}! Don't you dare touch my\npizza! Get back here!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Var1YeahAlrightHowMany[] = _("{STR_VAR_1}? Yeah, alright.\nHow many did ya want?");
const u8 gText_Var1AndYouWantedVar2[] = _("{STR_VAR_1}, and you want {STR_VAR_2}.\nThat will be ¥{STR_VAR_3}. Okay?");
const u8 gText_YouWantedVar2Var1[] = _("You wanted {STR_VAR_2} {STR_VAR_1}?\nThat's gonna cost ¥{STR_VAR_3}, bro.");
...
const u8 gText_HeresYourStuff[] = _("Here's your stuff.");
...
const u8 gText_DangYoureBroke[] = _("Dang, you're completely BROKE.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_AnythingElseBrah[] = _("Anything else I can do for you,\nbrah?");
const u8 gUnknown_84168BF[] = _("その ほかに\nなにか ちからに なれることは?");
const u8 gUnknown_84168D7[] = _("プレミアボ-ル 1コ\nおまけ しておきますね!{PAUSE_UNTIL_PRESS}");
const u8 gText_BossSaysNoSell[] = _("Sorry, bro, but the boss said I'm\nnot allowed to do that.");
...
const u8 gText_DexQuestionMarks[] = _("\n\n???");
...
const u8 gText_SideQuestName_BernardsGlasses[] = _("Bernard's Glasses");
...
const u8 gText_SideQuestDesc_BernardsGlasses[] = _("Bernard seems to have lost his\nglasses somewhere in Merson Cave.\nWould you mind looking for them?");
...
const u8 gText_SideQuestPOC_Bernard[] = _("Bernard");
...
const u8 gText_SideQuestMap_MersonCave[] = _("Merson Cave");

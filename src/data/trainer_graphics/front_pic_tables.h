...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(GAMBLER, gTrainerFrontPic_Gamer, 0x800),
    ...
    TRAINER_SPRITE(MURA_1, gTrainerFrontPic_Mura1, 0x800),
    TRAINER_SPRITE(YOUNGSTER_2, gTrainerFrontPic_Youngster2, 0x800),
    TRAINER_SPRITE(BUG_CATCHER_2, gTrainerFrontPic_BugCatcher2, 0x800),
    ...
    TRAINER_SPRITE(ROCKET_GRUNT_M_2, gTrainerFrontPic_RocketGruntM2, 0x800),
    TRAINER_SPRITE(ROCKET_GRUNT_F_2, gTrainerFrontPic_RocketGruntF2, 0x800),
    TRAINER_SPRITE(LASS_2, gTrainerFrontPic_Lass2, 0x800),
    TRAINER_SPRITE(FIRE_BREATHER, gTrainerFrontPic_FireBreather, 0x800),
    TRAINER_SPRITE(SCIENTIST_2, gTrainerFrontPic_Scientist2, 0x800),
    TRAINER_SPRITE(COWGIRL, gTrainerFrontPic_Cowgirl, 0x800),
    TRAINER_SPRITE(SWIMMER_F_2, gTrainerFrontPic_SwimmerF2, 0x800),
    TRAINER_SPRITE(COLLECTOR_2, gTrainerFrontPic_Collector2, 0x800),
    TRAINER_SPRITE(GENTLEMAN_2, gTrainerFrontPic_Gentleman2, 0x800),
    TRAINER_SPRITE(CAMPER_2, gTrainerFrontPic_Camper2, 0x800),
    TRAINER_SPRITE(PICNICKER_2, gTrainerFrontPic_Picnicker2, 0x800),
    TRAINER_SPRITE(GUITARIST_2, gTrainerFrontPic_Guitarist2, 0x800),
    TRAINER_SPRITE(FISHERMAN_2, gTrainerFrontPic_Fisherman2, 0x800),
    TRAINER_SPRITE(WORKER, gTrainerFrontPic_Worker, 0x800),
    TRAINER_SPRITE(KARPMAN, gTrainerFrontPic_Karpman, 0x800),
    TRAINER_SPRITE(POKEMANIAC_2, gTrainerFrontPic_PokeManiac2, 0x800),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(GAMBLER, gTrainerPalette_Gamer),
    ...
    TRAINER_PAL(MURA_1, gTrainerPalette_Mura1),
    TRAINER_PAL(YOUNGSTER_2, gTrainerPalette_Youngster2),
    TRAINER_PAL(BUG_CATCHER_2, gTrainerPalette_BugCatcher2),
    TRAINER_PAL(RANCHER, gTrainerPalette_Rancher),
    TRAINER_PAL(ACE_TRAINER_M, gTrainerPalette_AceTrainer),
    TRAINER_PAL(ACE_TRAINER_F, gTrainerPalette_AceTrainer),
    TRAINER_PAL(ROCKET_GRUNT_M_2, gTrainerPalette_RocketGruntM2),
    TRAINER_PAL(ROCKET_GRUNT_F_2, gTrainerPalette_RocketGruntF2),
    TRAINER_PAL(LASS_2, gTrainerPalette_Lass2),
    TRAINER_PAL(FIRE_BREATHER, gTrainerPalette_FireBreather),
    TRAINER_PAL(SCIENTIST_2, gTrainerPalette_Scientist2),
    TRAINER_PAL(COWGIRL, gTrainerPalette_Cowgirl),
    TRAINER_PAL(SWIMMER_F_2, gTrainerPalette_SwimmerF2),
    TRAINER_PAL(COLLECTOR_2, gTrainerPalette_Collector2),
    TRAINER_PAL(GENTLEMAN_2, gTrainerPalette_Gentleman2),
    TRAINER_PAL(CAMPER_2, gTrainerPalette_Camper2),
    TRAINER_PAL(PICNICKER_2, gTrainerPalette_Picnicker2),
    TRAINER_PAL(GUITARIST_2, gTrainerPalette_Guitarist2),
    TRAINER_PAL(FISHERMAN_2, gTrainerPalette_Fisherman2),
    TRAINER_PAL(WORKER, gTrainerPalette_Worker),
    TRAINER_PAL(KARPMAN, gTrainerPalette_Karpman),
    TRAINER_PAL(POKEMANIAC_2, gTrainerPalette_PokeManiac2),
};

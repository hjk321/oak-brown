...
static const s8 sSeag[][4] = {
                                   // Map                     X     Y
    [SEAGALLOP_VERMILION_CITY]  = {MAP(DEBUG_PLACEHOLDER),      0x17, 0x20},
    [SEAGALLOP_ONE_ISLAND]      = {MAP(DEBUG_PLACEHOLDER),   0x08, 0x05},
    [SEAGALLOP_TWO_ISLAND]      = {MAP(DEBUG_PLACEHOLDER),   0x08, 0x05},
    [SEAGALLOP_THREE_ISLAND]    = {MAP(DEBUG_PLACEHOLDER), 0x08, 0x05},
    [SEAGALLOP_FOUR_ISLAND]     = {MAP(DEBUG_PLACEHOLDER),  0x08, 0x05},
    [SEAGALLOP_FIVE_ISLAND]     = {MAP(DEBUG_PLACEHOLDER),  0x08, 0x05},
    [SEAGALLOP_SIX_ISLAND]      = {MAP(DEBUG_PLACEHOLDER),   0x08, 0x05},
    [SEAGALLOP_SEVEN_ISLAND]    = {MAP(DEBUG_PLACEHOLDER), 0x08, 0x05},
    [SEAGALLOP_CINNABAR_ISLAND] = {MAP(DEBUG_PLACEHOLDER),     0x15, 0x07},
    [SEAGALLOP_NAVEL_ROCK]      = {MAP(DEBUG_PLACEHOLDER),   0x08, 0x05},
    [SEAGALLOP_BIRTH_ISLAND]    = {MAP(DEBUG_PLACEHOLDER), 0x08, 0x05}
};

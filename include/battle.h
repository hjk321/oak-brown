...
#define IS_MOVE_PHYSICAL(move)(move.physicality == MOVE_PHYSICALITY_PHYSICAL)
#define IS_MOVE_SPECIAL(move)(move.physicality == MOVE_PHYSICALITY_SPECIAL)
...
extern u8 gNumTrainerFleeAttempts;

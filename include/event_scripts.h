...
extern const u8 gNameChoice_Mura[];
extern const u8 gNameChoice_Brown[];
extern const u8 gNameChoice_Adam[];
extern const u8 gNameChoice_Paul[];
extern const u8 gNameChoice_Kyle[];
...
extern const u8 EventScript_ShutDownPlayerPC[];
